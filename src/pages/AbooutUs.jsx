      ...
      <section className="bg-[#0B0B14] min-h-screen">
        ...
        <section className="bg-[#0B0B14] px-10 gap-6 lg:gap-20  items-stretch flex flex-col lg:flex-row">
          ...
          <div className="flex justify-center items-center gap-10 ">
            <p className="border border-white/70 rounded-4xl p-6 text-white font-light text-justify h-full lg:max-w-[900px] flex justify-center items-center lg:text-lg 2xl:text-xl">
        ...
        <section className="flex flex-col bg-[#0B0B14] px-10 border-b border-b-white text-white">
          ...
          <p className="mt-5 border border-white/20 p-4 rounded-4xl text-white px-7 italic text-sm sm:text-[18px] lg:text-xl 2xl:text-2xl">
          ...
          <p className="mt-5 border border-white/20 p-4 rounded-4xl text-white px-7 italic text-sm sm:text-[18px] lg:text-xl 2xl:text-2xl mb-10">
